/* drivers/sharp/shdisp/data/shdisp_bl71y6_data_pa29.h  (Display Driver)
 *
...
#define BDIC_REG_OPT5_HT_L_VAL                  (0x9B)
#define BDIC_REG_OPT5_HT_H_VAL                  (0x00)
#define BDIC_REG_OPT6_LT_L_VAL                  (0x85)
...
#define BDIC_REG_OPT8_HT_L_VAL                  (0xEB)
#define BDIC_REG_OPT8_HT_H_VAL                  (0x01)
#define BDIC_REG_OPT9_LT_L_VAL                  (0xA5)
#define BDIC_REG_OPT9_LT_H_VAL                  (0x01)
#define BDIC_REG_OPT9_HT_L_VAL                  (0x45)
#define BDIC_REG_OPT9_HT_H_VAL                  (0x03)
#define BDIC_REG_OPT10_LT_L_VAL                 (0xBB)
#define BDIC_REG_OPT10_LT_H_VAL                 (0x02)
#define BDIC_REG_OPT10_HT_L_VAL                 (0xE5)
#define BDIC_REG_OPT10_HT_H_VAL                 (0x04)
#define BDIC_REG_OPT11_LT_L_VAL                 (0x5B)
#define BDIC_REG_OPT11_LT_H_VAL                 (0x04)
#define BDIC_REG_OPT11_HT_L_VAL                 (0x25)
#define BDIC_REG_OPT11_HT_H_VAL                 (0x07)
#define BDIC_REG_OPT12_LT_L_VAL                 (0x4B)
#define BDIC_REG_OPT12_LT_H_VAL                 (0x06)
#define BDIC_REG_OPT12_HT_L_VAL                 (0xF5)
#define BDIC_REG_OPT12_HT_H_VAL                 (0x0A)
#define BDIC_REG_OPT13_LT_L_VAL                 (0x7B)
#define BDIC_REG_OPT13_LT_H_VAL                 (0x09)
#define BDIC_REG_OPT13_HT_L_VAL                 (0x50)
#define BDIC_REG_OPT13_HT_H_VAL                 (0x12)
#define BDIC_REG_OPT14_LT_L_VAL                 (0x60)
#define BDIC_REG_OPT14_LT_H_VAL                 (0x0F)
#define BDIC_REG_OPT14_HT_L_VAL                 (0xE0)
#define BDIC_REG_OPT14_HT_H_VAL                 (0x1F)
#define BDIC_REG_OPT15_LT_L_VAL                 (0x90)
#define BDIC_REG_OPT15_LT_H_VAL                 (0x1A)
#define BDIC_REG_OPT15_HT_L_VAL                 (0xF0)
#define BDIC_REG_OPT15_HT_H_VAL                 (0x3D)
#define BDIC_REG_OPT16_LT_L_VAL                 (0x90)
#define BDIC_REG_OPT16_LT_H_VAL                 (0x31)
#define BDIC_REG_OPT16_HT_L_VAL                 (0x70)
#define BDIC_REG_OPT16_HT_H_VAL                 (0x60)
#define BDIC_REG_OPT17_LT_L_VAL                 (0x60)
#define BDIC_REG_OPT17_LT_H_VAL                 (0x55)
#define BDIC_REG_OPT17_HT_L_VAL                 (0x00)
#define BDIC_REG_OPT17_HT_H_VAL                 (0x84)
#define BDIC_REG_OPT18_LT_L_VAL                 (0xC0)
#define BDIC_REG_OPT18_LT_H_VAL                 (0x77)
#define BDIC_REG_OPT18_HT_L_VAL                 (0x6B)
#define BDIC_REG_OPT18_HT_H_VAL                 (0xB6)
#define BDIC_REG_OPT19_LT_L_VAL                 (0x55)
#define BDIC_REG_OPT19_LT_H_VAL                 (0xA3)
#define BDIC_REG_OPT19_HT_L_VAL                 (0x80)
#define BDIC_REG_OPT19_HT_H_VAL                 (0xED)
#define BDIC_REG_OPT20_LT_L_VAL                 (0xB8)
#define BDIC_REG_OPT20_LT_H_VAL                 (0x0D)
#define BDIC_REG_OPT20_HT_L_VAL                 (0x32)
#define BDIC_REG_OPT20_HT_H_VAL                 (0x14)
#define BDIC_REG_OPT21_LT_L_VAL                 (0x15)
#define BDIC_REG_OPT21_LT_H_VAL                 (0x12)
#define BDIC_REG_OPT21_HT_L_VAL                 (0x19)
#define BDIC_REG_OPT21_HT_H_VAL                 (0x1E)
#define BDIC_REG_OPT22_LT_L_VAL                 (0x34)
#define BDIC_REG_OPT22_LT_H_VAL                 (0x1A)
#define BDIC_REG_OPT22_HT_L_VAL                 (0xA9)
#define BDIC_REG_OPT22_HT_H_VAL                 (0x27)
#define BDIC_REG_OPT23_LT_L_VAL                 (0xD4)
#define BDIC_REG_OPT23_LT_H_VAL                 (0x24)
